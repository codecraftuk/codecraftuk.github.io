...
For the adventurous (bordering on crazy), you may want to have the following installed on your system: gcc build tools, git,  Erlang 23.x, rebar3, and a clone of the undertone repository: https://github.com/ut-proj/undertone
